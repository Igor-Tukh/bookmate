...
def get_absolute_speeds_for_borders(target_users, sessions_collection, borders_abs_speeds, borders_sessions_num):
...
def get_unsusual_sessions_for_borders(sessions_collection, borders_num):
